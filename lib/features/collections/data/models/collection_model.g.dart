...
extension CollectionModelQuerySortBy
  ...
  QueryBuilder<CollectionModel, CollectionModel, QAfterSortBy> sortByEmoji() {
    return QueryBuilder.apply(this, (query) {
...
extension CollectionModelQuerySortThenBy
  ...
  QueryBuilder<CollectionModel, CollectionModel, QAfterSortBy> thenByEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.asc);
    });
  }
...
extension CollectionModelQueryWhereDistinct
  ...
  QueryBuilder<CollectionModel, CollectionModel, QDistinct> distinctByEmoji(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CollectionModelQueryProperty
  ...
  QueryBuilder<CollectionModel, String?, QQueryOperations> emojiProperty() {
    return QueryBuilder.apply(this, (query) {
