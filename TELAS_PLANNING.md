...
| 5 | Listel — Home | collections | ⏳ Planejado | 🔴 Alta | home_page.dart (refactor) |
...
| 11 | Perfil do Usuário | sharing | ⏳ Planejado | 🟡 Média | user_profile_page.dart |
...
## 📄 Detalhes das Tarefas — Links Rápidos

### Fase 1 — Foundation (Auth) 🔐
1. **[TAREFA_1_login.md](TAREFA_1_login.md)** — Login Page
   - Email/senha, validações, redirect após sucesso
   - Repositório `AuthRepository`, Provider `SignInNotifier`

2. **[TAREFA_2_signup.md](TAREFA_2_signup.md)** — Signup Page
   - Criar conta, força de senha, termos de serviço
   - Reutiliza `AuthRepository`, novo `SignUpNotifier`

3. **[TAREFA_3_login_refinado.md](TAREFA_3_login_refinado.md)** — Login Refinado (Optional)
   - Versão polida com gradiente, animações, card flutuante
   - Reutiliza lógica de TAREFA 1

4. **[TAREFA_4_signup_refinado.md](TAREFA_4_signup_refinado.md)** — Signup Refinado (Optional)
   - Versão polida com barra de força de senha visual
   - Reutiliza lógica de TAREFA 2

### Fase 2 — Core Features 🎨
5. **[TAREFA_5_home_redesenhada.md](TAREFA_5_home_redesenhada.md)** — Home Page
   - Grid de coleções locais + seção compartilhadas
   - FAB duplo (local / compartilhada), search bar

6. **[TAREFA_6_adicionar_item_modernizado.md](TAREFA_6_adicionar_item_modernizado.md)** — Add Item
   - Criar/editar item com foto, preço, link, observações
   - Validações, contadores visuais, bottom action bar

7. **[TAREFA_7_detalhe_item.md](TAREFA_7_detalhe_item.md)** — Item Detail
   - Preview completo, toggle status, editar/deletar
   - Hero animation, share intent, buscar mais barato

8. **[TAREFA_8_salvar_produto.md](TAREFA_8_salvar_produto.md)** — Share Intent Flow
   - Bottom sheet de preview ao compartilhar link
   - Seletor de coleção, observações, feedback de sucesso

### Fase 3 — Social & Settings 👥
9. **[TAREFA_9_configuracoes.md](TAREFA_9_configuracoes.md)** — Settings Page
   - Tema (cor, dark/light), conta (logout), sobre

10. **[TAREFA_10_adicionar_amigos.md](TAREFA_10_adicionar_amigos.md)** — Add Members
    - Código de convite, link compartilhável, lista de membros

11. **[TAREFA_11_perfil_usuario.md](TAREFA_11_perfil_usuario.md)** — User Profile
...
| 5 | home_redesenhada.md | ⏳ Planejado | TAREFA 1 ✅ |
